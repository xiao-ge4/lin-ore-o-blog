const config = {
  ...
  metaData:{
    title: '格林定律🎉',
    description: 'Welcome to the interconnected world of Lin and Oreo!',
    keywords: 'Lin,Oreo,个人主页,个人网站',
    icon: '/favicon.ico'   //网页图标，支持外链
  },

  avatar: "/img/avatar.jpg", // 头像
  welcometitle: "Hi, Welcome", // 标题
  ...
  background: {
    "pc":{   //pc端
      ...
      "datainfo":{
        ...
        "url":"/img/wallpaper/static/夏日/summer-LO.png",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
      },
    },
    "mobile":{   //移动端
      "type":"pic",
  ...
  musicPlayer:{
    ...
    type: 'playlist',   //歌单类型
    id: '6767323773'  //歌单id ---> music.163.com/#/playlist?id=2028178887
  },
  ...
  projectcards:[ 
    {go:"🚀 前往",img:"/img/sunshine.jpg",title:"Project 1",subtitle:"1,000 miles of wonder", text:"If you see this line, I've managed to get your attention.",url:"/blog",show:false},
    ...
    {go:"📚 博客",img:"/img/sunshine.jpg",title:"我的博客",subtitle:"记录生活与技术", text:"点我进入博客页面，查看我的文章与图片。",url:"/blog",show:false},
    {go:"🧠 前往",img:"https://static.thenounproject.com/png/4595375-200.png",title:"Soul TalkBuddy",subtitle:"AI社交对话教练", text:"通过AI对手实战和实时建议，提升社交沟通技巧。支持MBTI个性化、场景模拟、多难度模式。",url:"/soul-talkbuddy",show:false},
  ],

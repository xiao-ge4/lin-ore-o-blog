...
import SoulTalkBuddyWrapper from './components/soul/SoulTalkBuddyWrapper.vue';
...
export default {
  ...
  data() {
    return {
      ...
      formattedDate:"",
      configdata: config,
      soulApiBase: import.meta.env.VITE_SOUL_API_BASE || 'http://localhost:8000',
      dialog1: false,
      dialog2: false,
